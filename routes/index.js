...
router.post('/api/logout', Sessions.sellerLogout, function(req, res){res.send(req.response);});

router.post('/api/login/mobile', Sessions.userLogin, function(req, res){res.send(req.response);});
...
router.get('/private/:id/*', Uploads.downloadCodes);
